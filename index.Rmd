...
- human cells 1:2:4 results
- Correlation between channels for human samples, slope should reflect differences in loading. 

---
## DIA-NN vs. MQ 

- correlogram between MQ and DIA-NN for intersect of two and correlation therein
- Jaccard index of MQ and DIA-NN data 
- Number of hits w/ MQ and DIA-NN (bar plot)
